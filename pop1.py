...
def select_frnd():
    ...
    for frnd in friends:
        ...
        serial_no = serial_no + 1
    user_selected_frnd = input('Which one you want to send or raed message from ? ' )
...
def send_message():
    ...
    original_iamge = raw_input('What is the name of your image? ')
    output_path = 'output.png'
    Steganography.encode(original_iamge,output_path,message)
...
def start_chat(spy_name,spy_age,spy_rating):
    ...
    while show_menu:
        ...
        if menu_choice==1 :
            ...
            selected_frnd= select_frnd()
            print 'We are going to send message to ' + friends[selected_frnd()]
